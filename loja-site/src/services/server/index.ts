...
const _CORREIOS = '/correios/consulta/';

//FRETE
const getShipping = async (cep: string) => {
    const data = {
        "cep": cep
    }

    const result = await api.post(`${_CORREIOS}/frete`, data)
...
const getAddress = async (cep: string) => {
    ...
    const result = await api.post(`${_CORREIOS}/cep`, data)
...
export { getShipping, getAddress, getCategories, getProducts, getProductsByCategory, getProductById, signIn, createUserCustomer, getCustomerByUID, createOrder };